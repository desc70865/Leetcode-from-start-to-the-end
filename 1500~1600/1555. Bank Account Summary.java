...
select r.user_id as user_id,u.user_name as user_name,sum(r.credit) as credit,if(sum(r.credit)<0,'Yes','No') as credit_limit_breached 
from
(select user_id,credit
from Users
union all
select paid_by as user_id,-1*amount as credit
from Transactions 
union all
